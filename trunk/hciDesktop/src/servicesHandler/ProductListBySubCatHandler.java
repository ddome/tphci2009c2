...
public class ProductListBySubCatHandler {
	...
	public ProductListBySubCatHandler(int cathegory,int subcategory) {
		try{
			URL url = new URL("http://eiffel.itba.edu.ar/hci/service/Catalog.groovy?method=GetProductListBySubcategory&category_id="+cathegory+"&subcategory_id="+subcategory+"&language_id=1");
