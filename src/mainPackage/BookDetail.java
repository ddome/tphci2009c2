...
public class BookDetail extends javax.swing.JFrame{
    ...
    public BookDetail(ProductFullBook book) {
        initComponents(book);
    }
    ...
    private void initComponents(ProductFullBook book) {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(BookDetail.class);
    ...
    private void setValues(ProductFullBook book){
    	...
    	jLabel12.setText(book.authors);
    	jLabel13.setText(book.publisher);
    	jLabel14.setText(book.publish_date);
    	jLabel15.setText(book.ISBN);
    	jLabel16.setText(book.language);
